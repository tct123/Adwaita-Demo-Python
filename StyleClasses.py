    ...
    def __init__(self, *args, **kwargs):
        ...
        b.append(
            Gtk.Button(
                ...
                margin_bottom=10,
                margin_end=10,
                css_classes=["text-button", "suggested-action"],
            )
        )
        b.append(
            Gtk.Button(
                ...
                margin_bottom=10,
                margin_end=10,
                css_classes=["text-button", "destructive-action"],
            )
        )
        ...
        c.append(
            Gtk.Button(
                ...
                margin_bottom=10,
                margin_end=10,
                css_classes=["text-button", "circular"],
            )
        )
        c.append(
            Gtk.Button(
        ...
        w = Gtk.Box(
            css_classes=["toolbar"], margin_top=10, margin_start=10, margin_bottom=10
        )
        w.append(Gtk.Button(icon_name="tab-new-symbolic", css_classes=["image-button"]))
        w.append(Gtk.Entry(hexpand=True))
        w.append(
            Gtk.Button(icon_name="window-close-symbolic", css_classes=["image-button"])
        )
        ...
        l.append(
            Gtk.Button(
                icon_name="media-playback-start-symbolic", css_classes=["image-button"]
            )
        )
        l.append(Gtk.ProgressBar(hexpand=True, valign=Gtk.Align.CENTER))
        l.append(
            Gtk.Button(icon_name="media-record-symbolic", css_classes=["image-button"])
        )
