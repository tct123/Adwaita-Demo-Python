...
class MainWindow(Gtk.ApplicationWindow):
    def __init__(self, *args, **kwargs):
        ...
        d1.append(
            Gtk.Label(
                label="Carousel", margin_start=120, margin_bottom=30, margin_end=120
            )
        )
        b.append(d1)
        d2 = Gtk.Box(
        ...
        d2.append(
            Gtk.Label(
                label="LibAdwaita", margin_start=120, margin_bottom=30, margin_end=120
            )
        )
        b.append(d2)
        d3 = Gtk.Box(
        ...
        d3.append(
            Gtk.Label(
                label="Python", margin_start=120, margin_bottom=30, margin_end=120
            )
        )
        b.append(d3)
        d4 = Gtk.Box(
        ...
        d4.append(
            Gtk.Label(
                label="Example", margin_start=120, margin_bottom=30, margin_end=120
            )
        )
        b.append(d4)
